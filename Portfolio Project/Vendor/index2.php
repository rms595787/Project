...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300" data-aos-easing="slide"
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target scrolled sleep awake"
    id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index1.html"><span>R</span>ahul Sharma</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav nav ml-auto">
          ...
          <li class="nav-item"><a href="#about-section" class="nav-link active"><span>About</span></a></li>
          <li class="nav-item"><a href="#resume-section" class="nav-link"><span>Resume</span></a></li>
          <li class="nav-item"><a href="#services-section" class="nav-link"><span>Services</span></a></li>
          <li class="nav-item"><a href="#projects-section" class="nav-link"><span>Projects</span></a></li>
          <li class="nav-item"><a href="#blog-section" class="nav-link"><span>My Blog</span></a></li>
          <li class="nav-item"><a href="#contact-section" class="nav-link"><span>Contact</span></a></li>
          <li class="nav-item" id="sign-up"><span><a href="logout.php">Log Out</a></span></li>
        </ul>
      </div>
    </div>
  </nav>
  <section class="hero-wrap js-fullheight" style="height: 271px;">
            ...
            <h2>I'm a
              <span class="txt-rotate" data-period="2000"
                data-rotate="[ &quot;Web Designer.&quot;, &quot;Developer.&quot;, &quot;Photographer.&quot;, &quot;Marketer.&quot;, &quot;Blogger&quot; ]"><span
                  class="wrap">Developer.</span></span>
            </h2>
          </div>
        </div>
      </div>
      ...
      <div class="row d-flex no-gutters">
        <div class="col-md-6 col-lg-6 d-flex">
          <div class="img-about img d-flex align-items-stretch">
            ...
            <div class="img d-flex align-self-stretch align-items-center"
              style="background-image:url(https://preview.colorlib.com/theme/ronaldo/images/about.jpg.webp);">
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-6 pl-md-5 py-5">
          <div class="row justify-content-start pb-3">
            <div class="col-md-12 heading-section ftco-animate fadeInUp ftco-animated">
              ...
              <ul class="about-info mt-4 px-md-0 px-2">
                <li class="d-flex"><span>Name:</span> <span>Rahul Sharma</span></li>
                <li class="d-flex"><span>Date of birth:</span> <span>October 19, 2004</span></li>
                <li class="d-flex"><span>Address:</span> <span>Khora Colony Ghaziabad Uttar Pradesh India</span></li>
                <li class="d-flex"><span>Zip code:</span> <span>201309</span></li>
                <li class="d-flex"><span>Email:</span> <span>rms595787@gmail.com</span></li>
                <li class="d-flex"><span>Phone: </span> <span>+91-9999X-XXXXX</span></li>
              </ul>
            </div>
          </div>
          <div class="counter-wrap ftco-animate d-flex mt-md-3 fadeInUp ftco-animated">
            <div class="text">
              <p class="mb-4">
                <span class="number" data-number="120">03</span>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm ftco-animate fadeInUp ftco-animated">
          <a href="#" class="partner"><img src="https://preview.colorlib.com/theme/ronaldo/images/partner-1.png" class="img-fluid" alt="Colorlib Template"></a>
        </div>
        <div class="col-sm ftco-animate fadeInUp ftco-animated">
          <a href="#" class="partner"><img src="https://preview.colorlib.com/theme/ronaldo/images/partner-2.png.webp" class="img-fluid" alt="Colorlib Template"></a>
        </div>
        <div class="col-sm ftco-animate fadeInUp ftco-animated">
          <a href="#" class="partner"><img src="https://preview.colorlib.com/theme/ronaldo/images/partner-3.png.webp" class="img-fluid" alt="Colorlib Template"></a>
        </div>
        <div class="col-sm ftco-animate fadeInUp ftco-animated">
          <a href="#" class="partner"><img src="https://preview.colorlib.com/theme/ronaldo/images/partner-4.png" class="img-fluid" alt="Colorlib Template"></a>
        </div>
        <div class="col-sm ftco-animate fadeInUp ftco-animated">
          <a href="#" class="partner"><img src="https://preview.colorlib.com/theme/ronaldo/images/partner-5.png" class="img-fluid" alt="Colorlib Template"></a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <nav id="navi">
            <ul>
              <li><a href="#page-1" class="">Education</a></li>
          ...
          <div id="page-1" class="page one">
            ...
            <div class="resume-wrap d-flex ftco-animate fadeInUp ftco-animated">
              ...
              <div class="text pl-3">
                ...
                <h2>Build Ethical, Effective Communication, Productive Mindset and Core Employability Skills</h2>
                <span class="position">Freedom Employability Academy</span>
            ...
            <div class="resume-wrap d-flex ftco-animate fadeInUp ftco-animated">
              ...
              <div class="text pl-3">
                ...
                <span class="position">IBM(Coursera)</span>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a
                  paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
              </div>
            </div>
            <div class="resume-wrap d-flex ftco-animate fadeInUp ftco-animated">
              ...
              <div class="text pl-3">
                <span class="date">2022-2023</span>
                <h2>Python Basics</h2>
                <span class="position">University of Michigan(Coursera)</span>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a
                  paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
              </div>
            </div>
        ...
        <div id="page-2" class="page two">
          ...
          <div class="resume-wrap d-flex ftco-animate fadeInUp ftco-animated">
            ...
            <div class="text pl-3">
              ...
              <span class="position">Noida Institute of Engineeing &amp; Technology</span>
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a
                paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
            </div>
          </div>
          <div class="resume-wrap d-flex ftco-animate fadeInUp ftco-animated">
            ...
            <div class="text pl-3">
              ...
              <span class="position">SkillVertex</span>
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a
                paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
            </div>
          </div>
        ...
        <div id="page-4" class="page four">
          ...
          <div class="resume-wrap d-flex ftco-animate fadeInUp ftco-animated">
            ...
            <div class="text pl-3">
              ...
              <span class="position">Noida Institute of Engineeing &amp; Technology</span><br>
              <span class="position">GL Bajaj Institute of Technology</span>
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a
                paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
            </div>
          </div>
      ...
      <div class="row no-gutters">
        <div class="col-md-4">
          <div class="project img ftco-animate d-flex justify-content-center align-items-center fadeInUp ftco-animated"
            style="background-image: url(https://preview.colorlib.com/theme/ronaldo/images/work-1.jpg.webp);">
            <div class="overlay"></div>
        ...
        <div class="col-md-4">
          <div class="project img ftco-animate d-flex justify-content-center align-items-center fadeInUp ftco-animated"
            style="background-image: url(https://preview.colorlib.com/theme/ronaldo/images/work-2.jpg.webp);">
            <div class="overlay"></div>
            <div class="text text-center p-4">
              <h3><a href="#">Branding &amp; Illustration Design</a></h3>
              <span>Web Design</span>
        ...
        <div class="col-md-4">
          <div class="project img ftco-animate d-flex justify-content-center align-items-center fadeInUp ftco-animated"
            style="background-image: url(https://preview.colorlib.com/theme/ronaldo/images/work-3.jpg.webp);">
            <div class="overlay"></div>
            <div class="text text-center p-4">
              <h3><a href="#">Branding &amp; Illustration Design</a></h3>
              <span>Web Design</span>
        ...
        <div class="col-md-4">
          <div class="project img ftco-animate d-flex justify-content-center align-items-center fadeInUp ftco-animated"
            style="background-image: url(https://preview.colorlib.com/theme/ronaldo/images/work-4.jpg.webp);">
            <div class="overlay"></div>
            <div class="text text-center p-4">
              <h3><a href="#">Branding &amp; Illustration Design</a></h3>
              <span>Web Design</span>
        ...
        <div class="col-md-4">
          <div class="project img ftco-animate d-flex justify-content-center align-items-center fadeInUp ftco-animated"
            style="background-image: url(https://preview.colorlib.com/theme/ronaldo/images/work-5.jpg.webp);">
            <div class="overlay"></div>
            <div class="text text-center p-4">
              <h3><a href="#">Branding &amp; Illustration Design</a></h3>
              <span>Web Design</span>
        ...
        <div class="col-md-4">
          <div class="project img ftco-animate d-flex justify-content-center align-items-center fadeInUp ftco-animated"
            style="background-image: url(https://preview.colorlib.com/theme/ronaldo/images/work-6.jpg.webp);">
            <div class="overlay"></div>
            <div class="text text-center p-4">
              <h3><a href="#">Branding &amp; Illustration Design</a></h3>
              <span>Web Design</span>
    ...
    <div class="container">
      ...
      <div class="row no-gutters block-9">
        ...
        <div class="col-md-6 d-flex">
          <div class="img" style="background-image: url(https://preview.colorlib.com/theme/ronaldo/images/about.jpg.webp);"></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <script defer=""
    ...
    data-cf-beacon="{&quot;rayId&quot;:&quot;801e793f5c4ef36f&quot;,&quot;token&quot;:&quot;cd0b4b3a733644fc843ef0b185f98241&quot;,&quot;version&quot;:&quot;2023.8.0&quot;,&quot;si&quot;:100}"
